...
#SBATCH -J runTemp           # Job name
#SBATCH -o runTemp.o%j       # Name of stdout output file
#SBATCH -e runTemp.e%j       # Name of stderr error file
#SBATCH -p normal          # Queue (partition) name
#SBATCH -N 1               # Total # of nodes (must be 1 for serial)
#SBATCH -n 4               # Total # of mpi tasks (should be 1 for serial)
#SBATCH -t 01:02:00        # Run time (hh:mm:ss)
...
#step 4 create metagraph/ mappings
python3 metagraph.py livejournal
